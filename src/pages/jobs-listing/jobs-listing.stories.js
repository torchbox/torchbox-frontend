...
storiesOf('Pages', module).add('Job Listing', () => {
  return (
    <BlogListingPage
      ...
      jobs={[
        {
          "url": "http://torchbox.applytojob.com/apply/9rpxkBYWBv/Senior-Django-Developer",
          "level": "Senior",
          "location": "Bristol or Charlbury",
          "title": "Senior Django Developer"
        },
        {
          "url": "https://torchbox.applytojob.com/apply/mSdQToIH2x/PPC-Account-Manager",
          "level": "Experienced",
          "location": "Bristol or Charlbury",
        ...
        {
          "url": "https://torchbox.applytojob.com/apply/gRpG9xWdDE/Front-End-Developer",
          "level": "Junior",
          "location": "Bristol or Charlbury",
