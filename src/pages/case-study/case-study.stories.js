  ...
  return (
    <CaseStudyPage
      ...
      streamfield={[
        {
          "type": "intro",
          "value": "<p>Before we made the decision to <a id=\"1186\" linktype=\"page\">stop working with Drupal</a> we got a brief through the door that made us think twice.</p>"
        },
        {
          "type": "paragraph",
          "value": "<p>Nesta, the global innovation foundation (they&#x27;re pretty much our perfect client, our strapline is <i>digital for good</i> and Nesta are all about innovation for good) wanted to transform their digital presence, building a new nesta.org.uk on a next generation platform.</p>"
        },
        {
          "type": "h3",
        ...
        },
        {
          ...
          "value": {
            ...
            "alignment": "full",
            "caption": "The Incredible Growth of Python, September 6, 2017: https://stackoverflow.blog/2017/09/06/incredible-growth-python/",
            "attribution": ""
          }
        },
        {
          "type": "pullquote",
          "value": {
            "quote": "Python is fast enough for our site and allows us to produce maintainable features in record times, with a minimum of developers",
            "attribution": "Cuong Do, Software Architect, YouTube.com"
          }
        },
        {
          "type": "paragraph",
          "value": "<ul><li><b>Personalisation capabilities -</b> personalisation, or customer experience, will trickle down over time to play a more important role in more and more sites. Wagtail already has <a href=\"https://torchbox.com/blog/magic-personalisation/\">some exciting personalisation tools</a> that are powerful and free.</li><li><b>Creative solutions drawn from insights into their users -</b> we focused on combining personalisation with feature ideas to show how we imagine the next generation Nesta site will work, for example, how we would handle really long, long-form content.</li></ul>"
        },
        {
          "type": "paragraph",
          "value": "<p>Nesta ruled out a number of agencies with too much of a focus on technology. They wanted a partner that focused on their challenges, their audiences, and that would give pushback where needed. Happily, Nesta chose us and Wagtail.<br/></p>"
        },
        {
          "type": "h3",
        ...
        {
          "type": "paragraph",
          "value": "<p>Nesta&#x27;s key project concerns were around:</p><ul><li>A successful, digital implementation of <a href=\"https://www.pentagram.com/work/nesta\">their new brand by Pentagram</a></li><li>Content migration (with nearly 5k pages, this is a big site!)</li><li>Their distributed CMS editor base having to move from D7 to another system</li></ul><p>We&#x27;re delighted that all of these key concerns were successfully met. Nesta love the brand implementation. Nesta product manager, Sara, felt that the migration went &quot;really well, much more smoothly than previous experiences&quot; (346 person pages, 125 users, 467 guest authors, 1616 blogs, 561 reports and 35 toolkits). But, perhaps most pleasing was how easily their editors adopted Wagtail.</p><p>More than fifty editors are already using Wagtail at Nesta, and the feedback has been overwhelmingly positive, &quot;it&#x27;s been very easy for people to pick up&quot;. Just as well as some of these editors only use a CMS a couple of times a year so switching might have been annoying. People have loved moving from the world of the <i>big text area</i> style of CMS publishing to something with the flexibility of Wagtail&#x27;s Streamfield, only one person has missed being able to dump all their content into one text box (with the many associated problems that brings).</p><p></p>"
        },
        {
          "type": "aligned_image",
          "value": {
            ...
            "alignment": "full",
            "caption": "From wireframing to developing and evolving the new Nesta brand",
            "attribution": ""
          }
        },
        {
        ...
        {
          "type": "paragraph",
          "value": "<p>As Sara says, “it was never our intention that launch would be it. A program of user testing is imminent on the live site and then we’ll be starting with the iterative improvements and innovations.”</p><p>We’re looking forward to getting stuck in.</p>"
        }
      ]}
      caseStudies={[
        {
